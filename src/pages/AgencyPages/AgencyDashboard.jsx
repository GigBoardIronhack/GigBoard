...
const AgencyDashboard = () => {
  ...
  return (
    <>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 lg:grid-rows-3 gap-4">
        <div className="sm:row-span-1 lg:col-start-3 dark:bg-gray-800 dark:text-white">
        ...
        <div className="row-span-1 sm:row-span-1 lg:row-span-2 lg:col-span-2 lg:col-start-1 lg:row-start-1">
          <CardGrid type="wideArtists" cards={currentUser.artists} />
        </div>
        <div className="row-span-1 sm:row-span-1 lg:row-span-2 lg:col-span-2 lg:col-start-4 lg:row-start-1">
