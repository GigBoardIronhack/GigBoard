...
const Navbar = () => {
    ...
    <nav className="relative z-50 bg-gray-200 p-4">
      ...
      <div className="flex justify-between items-center w-full">
        ...
        <div className="hidden md:flex space-x-6">
          {currentUser ? (
            <>
              <NavLink to="/dashboard" className="hover:text-black-600">
                Dashboard
              </NavLink>
              ...
              >
                <NavLink to="/artists">
                  <button className="hover:text-black-600">Artists</button>
                </NavLink>
                {showDropdown && (
              ...
              <NavLink to="/purposals" className="hover:text-black-600">
                Purposals
              </NavLink>
            </>
          ) : (
            <>
              <NavLink to="/register" className="hover:text-black-600">
                Register
              </NavLink>
              <NavLink to="/login" className="hover:text-black-600">
                Login
              </NavLink>
            </>
          )}
  ...
  className={({ isActive }) =>
    isActive ? "font-bold text-blue-500" : "text-gray-500 px-4 py-2 rounded"
  }
>
  Dashboard
</NavLink>
              ...
              <div className="w-full text-center">
                <button
                  className="hover:text-black-600 w-full"
