...
const WidePurposalCard = ({ card, setNeedRefresh }) => {
  ...
  return (
    <>
      <div>
        <div className="flex flex-col p-4  lg:min-h-[120px] lg:row-span-2 lg:flex-row justify-around shadow-medium rounded-small  w-full">
          <div className="flex flex-col py-4 items-center justify-center lg:items-start lg:justify-start p-2 w-full lg:w-2/4">
            <div className="flex flex-col lg:flex-row items-center lg:items-start w-full lg:w-1/3">
              <div className="w-full lg:w-20 text-center">
                {currentUser.role === "promoter" && <p>propuesta para</p>}
                <p className="w-full lg:w-2/1 overflow-hidden text-ellipsis whitespace-nowrap">
                  {card?.promoter?.name}
                </p>
              </div>
              ...
              <div>
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="w-6 h-6 transform rotate-90 lg:rotate-0 text-gray-700"
                >
                  <path d="M10 17l5-5-5-5v10z" />
                </svg>
              </div>

              <div className="text-center lg:w-20 w-full">
